...
echo "send 0 Hello John, how are you?" > "${APP_HANDLER_STDIN}"
echo "receive 0 Hi Freddie, good and you?" > "${APP_HANDLER_STDIN}"
echo "send 0 Fine" > "${APP_HANDLER_STDIN}"
echo "select 1" > "${APP_HANDLER_STDIN}"
echo "send 1 What's up bro?" > "${APP_HANDLER_STDIN}"
echo "receive 1 Nothing" > "${APP_HANDLER_STDIN}"
echo "select 0" > "${APP_HANDLER_STDIN}"
